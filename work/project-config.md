...
- `.aifact/workflows/` contains the core workflow definitions such as `brainstorm`, `commit`, `create-guideline`, `create-story`, `refresh-project-config`, `story-analyzer`, `story-done`, `story-implementer`, `story-reviewer`, `story-start`, and `story-validator`.
- `.vibe/skills/` contains reusable Vibe skills such as `brainstorm`, `commit`, `create-guideline`, `create-story`, `refresh-project-config`, `story-analyzer`, `story-done`, `story-implementer`, `story-reviewer`, `story-start`, and `story-validator`.
